...
const initializer: CheckpointSaverTestInitializer<PostgresSaver> = {
  async beforeAll() {
...
// scenarioTest("@langchain/langgraph-checkpoint-postgres", initializer);
specTest("@langchain/langgraph-checkpoint-postgres", initializer);
